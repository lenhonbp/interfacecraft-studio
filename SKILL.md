...
8. **Evidence gate:** acceptance claims have evidence paths or explicit manual verification notes.
...
- `references/provenance.md` — neutral completion record, integrity hash, attribution limits, and completion line.
